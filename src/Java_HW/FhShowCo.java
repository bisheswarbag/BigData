...
public class FhShowCo {
	public static void main(String[] args) throws Exception {
		...
		File f1 = new File("F:/BIS_BIGDATA/File_handle/writeIntoFile.txt");
		...
		bw = new BufferedWriter(new FileWriter("F:/BIS_BIGDATA/File_handle/writeIntoFile.txt"));
		try {
